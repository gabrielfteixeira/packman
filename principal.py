...
class Game:
    ...
    def desenhar_sprites(self):
        ...
        self.todas_as_sprites.draw(self.tela) #dezenhando as sprites
        pygame.display.flip()

    def carregar_arquivos(self):
        #carregar os arquivos de audio e img
        diretorio_imagens = os.path.join(os.getcwd(),'imagens')
        self.diretorio_audios = os.path.join(os.getcwd(), 'audios')
        self.spritesheet = os.path.join(diretorio_imagens,constantes.SPRITESHEET)
        self.packman_start_logo = os.path.join(diretorio_imagens, constantes.PACKMAN_START_LOGO)
        self.packman_start_logo = pygame.image.load(self.packman_start_logo).convert()
    ...
    def mostrar_tela_start(self):
        ...
        self.mostrar_texto('Desenvolvido por GabES ^_^', 19, constantes.BRANCO, constantes.LARGURA/2, 570)
